import { toProductNode,;
    parseCatalogNode,
    parseCollectionsNode,
    parseOrderDetailsNode,
    getRawMediaUploadData,
    uploadingNecessaryImagesOfProduct, } from ../Utils;
import { S_WHATSAPP_NET,;
    jidNormalizedUser,
    getBinaryNodeChild, } from ../WABinary;
...
export default { makeBusinessSocket: makeBusinessSocket };
