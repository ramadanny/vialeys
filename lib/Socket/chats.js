import { default: NodeCache } from '@cacheable/node-cache';
import { Boom } from '@hapi/boom';
import { proto } from '../../WAProto.js';
import { CALL_VIDEO_PREFIX,;    CALL_AUDIO_PREFIX, } from '../Defaults/prefix.js';
import { DEFAULT_CACHE_TTLS } from '../Defaults/constants.js';
import { PROCESSABLE_HISTORY_TYPES } from '../Defaults/history.js';
import { SyncState, ALL_WA_PATCH_NAMES } from '../Types.js';
import { newLTHashState,;    processSyncAction,
    extractSyncdPatches,
    ...
    getHistoryMsg,
    processMessage, } from ../Utils;
import { makeMutex } from '../Utils/make-mutex.js';
import { isPnUser,;    getBinaryNodeChild,
    getBinaryNodeChildren,
    jidDecode,
    jidNormalizedUser,
    reduceBinaryNodeToDictionary,
    S_WHATSAPP_NET, } from ../WABinary;
import { USyncUser, USyncQuery } from '../WAUSync.js';
import { makeSocket } from './socket.js';
const MAX_SYNC_ATTEMPTS = 2;const makeChatsSocket = (config) => {
    const {
        logger: logger,
...
export default { makeChatsSocket: makeChatsSocket };
