...
export declare const makeNewsletterSocket: (config: SocketConfig) => {
  ...
  groupAcceptInviteV4: (
    key: string | import('../Types').WAMessageKey,
  ...
  fetchDisappearingDuration: (
    ...jids: string[]
  ) => Promise<import('../index').USyncQueryResultList[] | undefined>
  ...
  executeUSyncQuery: (
    usyncQuery: import('../index').USyncQuery
  ) => Promise<import('../index').USyncQueryResult | undefined>
  type: 'md'
  ws: any
