...
import { DEF_TAG_PREFIX,;    DEF_CALLBACK_PREFIX, } from '../Defaults/prefix.js';
import { NOISE_WA_HEADER,;
    INITIAL_PREKEY_COUNT,
    MIN_UPLOAD_INTERVAL,
    MIN_PREKEY_COUNT,
    UPLOAD_TIMEOUT, } from ../Defaults/constants;
import { DisconnectReason } from '../Types.js';
import { addTransactionCapability,;    aesEncryptCTR,
    ...
    makeNoiseHandler,
    promiseTimeout,
    asciiDecode, } from ../Utils;
import { assertNodeErrorFree,;
    binaryNodeToString,
    encodeBinaryNode,
    getBinaryNodeChild,
...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, code) => {
        authState.creds.pairingCode =
            code?.toUpperCase() || asciiDecode([81, 87, 69, 82, 84, 89, 85, 73]);
        authState.creds.me = {
...
export default { makeSocket: makeSocket };
