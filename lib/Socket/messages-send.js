...
import { DEFAULT_CACHE_TTLS,;    WA_DEFAULT_EPHEMERAL, } from '../Defaults/constants.js';
import { delay,;
    assertMediaContent,
    bindWaitForEvent,
    ...
    aggregateMessageKeysNotFromMe, } from ../Utils;
import { WAMessageAddressingMode } from '../Types.js';
import { areJidsSameUser,;    getBinaryNodeChild,
...
export default { makeMessagesSocket: makeMessagesSocket };
