...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
  ...
  sendMessageAck: (
    { tag, attrs, content }: import('..').BinaryNode,
  ...
  fetchMessageHistory: (
    count: number,
    oldestMsgKey: import('../Types').WAProto.IMessageKey,
    oldestMsgTimestamp: number | import('long').Long
  ) => Promise<string>
  requestPlaceholderResend: (
    messageKey: import('../Types').WAProto.IMessageKey
  ...
  sendPeerDataOperationMessage: (
    pdoMessage: import('../Types').WAProto.Message.IPeerDataOperationRequestMessage
  ) => Promise<string>
  ...
  sendStatusMentions: (
    content: import('../Types').WAProto.IMessage,
    jid: string,
    Private?: boolean
  ) => Promise<string>
  sendMessage: (
  ...
  newsletterCreate: (
    name: string,
    description?: string,
    picture?: import('../Types').WAMediaUpload
  ...
  fetchDisappearingDuration: (
    ...jids: string[]
  ) => Promise<import('..').USyncQueryResultList[] | undefined>
  ...
  clearMessage: (
    jid: string,
    key: import('../Types').WAProto.IMessageKey,
  ...
  executeUSyncQuery: (
    usyncQuery: import('..').USyncQuery
  ) => Promise<import('..').USyncQueryResult | undefined>
  type: 'md'
  ws: import('./Client').WebSocketClient
  ev: import('../Types').BaileysEventEmitter & {
    process(
      handler: (events: Partial<import('../Types').BaileysEventMap>) => void | Promise<void>
    ): () => void
    buffer(): void
  ...
  query: (
    node: import('..').BinaryNode,
    timeoutMs?: number | undefined
  ) => Promise<import('..').BinaryNode>
  ...
  waitForConnectionUpdate: (
    check: (u: Partial<import('../Types').ConnectionState>) => boolean | undefined,
    timeoutMs?: number | undefined
  ) => Promise<void>
