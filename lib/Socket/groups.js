...
const extractGroupMetadata = result => {
  ...
  const mode =
    group.attrs.addressing_mode === 'lid' ? WAMessageAddressingMode.LID : WAMessageAddressingMode.PN
  ...
  const metadata = {
    ...
    owner: group.attrs.creator
      ? jidNormalizedUser(
          mode === WAMessageAddressingMode.LID ? group.attrs.creator_pn : group.attrs.creator
        )
      : undefined,
