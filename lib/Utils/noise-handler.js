...
import { NOISE_MODE,;    WA_CERT_DETAILS, } from '../Defaults/constants.js';
import { decodeBinaryNode } from '../WABinary.js';
import { aesDecryptGCM,;    aesEncryptGCM,
    Curve,
    hkdf,
    sha256, } from ./crypto;
...
export default { makeNoiseHandler: makeNoiseHandler };
