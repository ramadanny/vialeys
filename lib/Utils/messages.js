...
import { URL_REGEX,;    WA_DEFAULT_EPHEMERAL, } from '../Defaults/constants.js';
import { MEDIA_KEYS } from '../Defaults/media.js';
import { WAProto, WAMessageStatus } from '../Types.js';
import { isJidGroup,;    isJidNewsletter,
    isJidStatusBroadcast,
    jidNormalizedUser, } from ../WABinary;
import { sha256 } from './crypto.js';
import { generateMessageID,;    getKeyAuthor,
    unixTimestampSeconds, } from ./generics;
import { downloadContentFromMessage,;
    encryptedStream,
    generateThumbnail,
    getAudioDuration,
    getAudioWaveform,
...
import { zip } from 'fflate';        const stickerData = {};
