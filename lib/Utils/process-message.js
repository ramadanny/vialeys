...
import { WAMessageStubType } from '../Types.js';
import { getDevice,;    getContentType,
    normalizeMessageContent, } from ../Utils;
...
const REAL_MSG_STUB_TYPES = new Set([;    WAMessageStubType.CALL_MISSED_GROUP_VIDEO,
