...
const { createHash, randomBytes, createHmac, createCipheriv, createDecipheriv } = require('crypto')
...
const { MEDIA_PATH_MAP, MEDIA_HKDF_KEY_MAPPING } = require('../Defaults/media')
const { DEFAULT_ORIGIN } = require('../Defaults/constants')
const { getBinaryNodeChild, getBinaryNodeChildBuffer, jidNormalizedUser } = require('../WABinary')
const { aesDecryptGCM, aesEncryptGCM, hkdf } = require('./crypto')
