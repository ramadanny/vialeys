...
import { parseBuffer,;
    parseFile,
    parseStream, } from music-metadata;
import { tmpdir } from 'os';
import { join } from 'path';
import { Readable, Transform } from 'stream';
import { proto } from '../../WAProto.js';
import { MEDIA_PATH_MAP,;    MEDIA_HKDF_KEY_MAPPING, } from '../Defaults/media.js';
import { DEFAULT_ORIGIN } from '../Defaults/constants.js';
import { getBinaryNodeChild,;    getBinaryNodeChildBuffer,
    jidNormalizedUser, } from ../WABinary;
import { aesDecryptGCM,;
    aesEncryptGCM,
    hkdf, } from ./crypto;
import { generateMessageID } from './generics.js';
const getTmpFilesDirectory = () => tmpdir();const getImageProcessingLibrary = () => {
    let sharp, jimp;
    try {
        sharp = require("sharp");
    } catch {}
