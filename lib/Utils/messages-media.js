...
async function generateThumbnail(file, mediaType, options) {
  ...
  if (mediaType === "image") {
    const { buffer: buffer, original: original } =
...
const encryptedStream = async (
  ...
  {
    logger: logger,
    saveOriginalFileIfRequired: saveOriginalFileIfRequired,
    opts: opts,
  } = {},
) => {
