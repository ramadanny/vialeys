...
import { md5,;    toNumber,
    ...
    updateMessageWithReaction, } from ../Utils;
import { jidDecode, jidNormalizedUser } from '../WABinary.js';
...
import KeyedDB from '@adiwajshing/keyed-db;.default'    const chats = new KeyedDB(chatKey, (c) => c.id);    const messages = {};
    const contacts = {};
    const groupMetadata = {};
    const presences = {};
