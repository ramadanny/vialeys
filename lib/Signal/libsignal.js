import { SessionCipher,;
    SessionBuilder,
    SessionRecord,
    ProtocolAddress, } from libsignal;
import { generateSignalPubKey } from '../Utils.js';
import { isHostedLidUser,;    isHostedPnUser,
    isLidUser,
    isPnUser,
    jidDecode,
    transferDevice,
    WAJIDDomains, } from ../WABinary;
import { SenderKeyName } from './Group/sender-key-name.js';
import { SenderKeyRecord } from './Group/sender-key-record.js';
import { GroupCipher,;    GroupSessionBuilder,
    SenderKeyDistributionMessage, } from ./Group;
import { LRUCache } from 'lru-cache';
import { LIDMappingStore } from './lid-mapping.js'function makeLibSignalRepository(auth, logger, pnToLIDFunc) {
...
export default { makeLibSignalRepository: makeLibSignalRepository };
