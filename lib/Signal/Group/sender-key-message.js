import { verifySignature,;
    calculateSignature, } from libsignal/src/curve;
import { proto } from '../../../WAProto.js';
import { CiphertextMessage } from './ciphertext-message.js'class SenderKeyMessage extends CiphertextMessage {
...
export default { SenderKeyMessage: SenderKeyMessage };
