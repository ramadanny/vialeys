...
$root.Adv = (function () {
  ...
  Adv.ADVSignedDeviceIdentityHMAC = (function () {
    ...
    Object.defineProperty(
      ADVSignedDeviceIdentityHMAC.prototype,
      "_accountType",
      {
    ...
    ADVSignedDeviceIdentityHMAC.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
    };
    ADVSignedDeviceIdentityHMAC.decode = function decode(
      reader,
      length,
      error,
    ) {
    ...
    ADVSignedDeviceIdentityHMAC.decodeDelimited = function decodeDelimited(
      reader,
    ) {
    ...
    ADVSignedDeviceIdentityHMAC.getTypeUrl = function getTypeUrl(
      typeUrlPrefix,
    ) {
  ...
  Adv.ADVSignedDeviceIdentity = (function () {
    ...
    Object.defineProperty(
      ADVSignedDeviceIdentity.prototype,
      "_accountSignatureKey",
      {
    ...
    ADVSignedDeviceIdentity.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
    ...
    ADVSignedDeviceIdentity.verify = function verify(message) {
      ...
      if (
        message.accountSignature != null &&
        message.hasOwnProperty("accountSignature")
      ) {
      ...
      if (
        message.deviceSignature != null &&
        message.hasOwnProperty("deviceSignature")
      ) {
  ...
  Adv.ADVDeviceIdentity = (function () {
    ...
    ADVDeviceIdentity.encode = function encode(message, writer) {
      ...
      if (
        message.keyIndex != null &&
        Object.hasOwnProperty.call(message, "keyIndex")
      )
    ...
    ADVDeviceIdentity.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
  ...
  Adv.ADVSignedKeyIndexList = (function () {
    ...
    Object.defineProperty(
      ADVSignedKeyIndexList.prototype,
      "_accountSignature",
      {
        get: $util.oneOfGetter(($oneOfFields = ["accountSignature"])),
        set: $util.oneOfSetter($oneOfFields),
    ...
    ADVSignedKeyIndexList.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
  ...
  Adv.ADVKeyIndexList = (function () {
    ...
    ADVKeyIndexList.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "currentIndex")
      )
    ...
    ADVKeyIndexList.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
      return this.encode(message, writer).ldelim();
    ...
    ADVKeyIndexList.verify = function verify(message) {
      ...
      if (
        message.currentIndex != null &&
        message.hasOwnProperty("currentIndex")
      ) {
      ...
      if (
        message.validIndexes != null &&
        message.hasOwnProperty("validIndexes")
      ) {
