...
export namespace LidMigrationSyncPayload {
  ...
  class LIDMigrationMappingSyncPayload implements ILIDMigrationMappingSyncPayload {
    ...
    public static create(
      properties?: LidMigrationSyncPayload.ILIDMigrationMappingSyncPayload
    ...
    public static encode(
      message: LidMigrationSyncPayload.ILIDMigrationMappingSyncPayload,
    ...
    public static toObject(
      message: LidMigrationSyncPayload.LIDMigrationMappingSyncPayload,
  ...
  class LIDMigrationMapping implements ILIDMigrationMapping {
     ...
     */
    public static create(
      properties?: LidMigrationSyncPayload.ILIDMigrationMapping
    ): LidMigrationSyncPayload.LIDMigrationMapping
     ...
     */
    public static encode(
      message: LidMigrationSyncPayload.ILIDMigrationMapping,
      writer?: $protobuf.Writer
    ): $protobuf.Writer
     ...
     */
    public static toObject(
      message: LidMigrationSyncPayload.LIDMigrationMapping,
      options?: $protobuf.IConversionOptions
    ): { [k: string]: any }
