  ...
  ServerSync.SyncdPatch = (function () {
    ...
    SyncdPatch.verify = function verify(message) {
      ...
      if (message.clientDebugData != null && message.hasOwnProperty('clientDebugData')) {
        ...
        if (
          !(
            (message.clientDebugData && typeof message.clientDebugData.length === 'number') ||
    ...
    SyncdPatch.fromObject = function fromObject(object) {
      ...
      if (object.snapshotMac != null)
        if (typeof object.snapshotMac === 'string')
          $util.base64.decode(
            object.snapshotMac,
            (message.snapshotMac = $util.newBuffer($util.base64.length(object.snapshotMac))),
            0
          )
    ...
    SyncdPatch.toObject = function toObject(message, options) {
      ...
      if (message.clientDebugData != null && message.hasOwnProperty('clientDebugData')) {
        object.clientDebugData =
          options.bytes === String
            ? $util.base64.encode(message.clientDebugData, 0, message.clientDebugData.length)
            : options.bytes === Array
      ...
      if (message.operation != null && message.hasOwnProperty('operation')) {
        object.operation =
          options.enums === String
            ? $root.ServerSync.SyncdMutation.SyncdOperation[message.operation] === undefined
              ? message.operation
  ...
  ServerSync.SyncdSnapshot = (function () {
    ...
    SyncdSnapshot.verify = function verify(message) {
      ...
      if (message.mac != null && message.hasOwnProperty('mac')) {
        properties._mac = 1
        if (
          !((message.mac && typeof message.mac.length === 'number') || $util.isString(message.mac))
        )
  ...
  ServerSync.ExternalBlobReference = (function () {
    ...
    ExternalBlobReference.verify = function verify(message) {
      ...
      if (message.fileEncSha256 != null && message.hasOwnProperty('fileEncSha256')) {
        ...
        if (
          !(
            (message.fileEncSha256 && typeof message.fileEncSha256.length === 'number') ||
    ...
    ExternalBlobReference.fromObject = function fromObject(object) {
      ...
      if (object.fileSha256 != null)
        if (typeof object.fileSha256 === 'string')
          $util.base64.decode(
            object.fileSha256,
            (message.fileSha256 = $util.newBuffer($util.base64.length(object.fileSha256))),
            0
          )
      ...
      if (object.fileEncSha256 != null)
        if (typeof object.fileEncSha256 === 'string')
          $util.base64.decode(
            ...
            (message.fileEncSha256 = $util.newBuffer($util.base64.length(object.fileEncSha256))),
            0
          )
        else if (object.fileEncSha256.length >= 0) message.fileEncSha256 = object.fileEncSha256
      return message
    }
    ...
    ExternalBlobReference.toObject = function toObject(message, options) {
      ...
      if (message.fileSizeBytes != null && message.hasOwnProperty('fileSizeBytes')) {
        if (typeof message.fileSizeBytes === 'number')
          object.fileSizeBytes =
            options.longs === String ? String(message.fileSizeBytes) : message.fileSizeBytes
        else
          object.fileSizeBytes =
      ...
      if (message.fileEncSha256 != null && message.hasOwnProperty('fileEncSha256')) {
        object.fileEncSha256 =
          options.bytes === String
            ? $util.base64.encode(message.fileEncSha256, 0, message.fileEncSha256.length)
            : options.bytes === Array
    ...
    ExitCode.verify = function verify(message) {
      ...
      if (message.code != null && message.hasOwnProperty('code')) {
        ...
        if (
          ...
          !(message.code && $util.isInteger(message.code.low) && $util.isInteger(message.code.high))
        )
        ...
        if (typeof message.code === 'number')
          ...
          object.code =
            options.longs === String
              ...
              : options.longs === Number
                ? new $util.LongBits(message.code.low >>> 0, message.code.high >>> 0).toNumber(true)
                : message.code
