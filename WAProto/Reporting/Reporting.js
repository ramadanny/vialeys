...
$root.Reporting = (function () {
  ...
  Reporting.Field = (function () {
    ...
    Field.encode = function encode(message, writer) {
      ...
      if (
        message.isMessage != null &&
        Object.hasOwnProperty.call(message, "isMessage")
      )
        writer.uint32(32).bool(message.isMessage);
      if (
        message.subfield != null &&
        Object.hasOwnProperty.call(message, "subfield")
      )
        for (
          var keys = Object.keys(message.subfield), i = 0;
          i < keys.length;
          ++i
        ) {
    ...
    Field.fromObject = function fromObject(object) {
      ...
      if (object.subfield) {
        ...
        message.subfield = {};
        for (
          var keys = Object.keys(object.subfield), i = 0;
          i < keys.length;
          ++i
        ) {
  ...
  Reporting.Config = (function () {
    ...
    Config.encode = function encode(message, writer) {
      ...
      if (message.field != null && Object.hasOwnProperty.call(message, "field"))
        for (
          var keys = Object.keys(message.field), i = 0;
          i < keys.length;
          ++i
        ) {
          writer.uint32(10).fork().uint32(8).uint32(keys[i]);
          $root.Reporting.Field.encode(
            message.field[keys[i]],
            writer.uint32(18).fork(),
          )
            .ldelim()
            .ldelim();
    ...
    Config.fromObject = function fromObject(object) {
      ...
      if (object.field) {
        ...
        message.field = {};
        for (
          var keys = Object.keys(object.field), i = 0;
          i < keys.length;
          ++i
        ) {
