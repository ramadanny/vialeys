...
export namespace MmsRetry {
  ...
  class ServerErrorReceipt implements IServerErrorReceipt {
    ...
    public static encode(
      message: MmsRetry.IServerErrorReceipt,
    ...
    public static toObject(
      message: MmsRetry.ServerErrorReceipt,
  ...
  class MediaRetryNotification implements IMediaRetryNotification {
    ...
    public static create(
      properties?: MmsRetry.IMediaRetryNotification
    ): MmsRetry.MediaRetryNotification
     ...
     */
    public static encode(
      message: MmsRetry.IMediaRetryNotification,
      writer?: $protobuf.Writer
    ): $protobuf.Writer
     ...
     */
    public static toObject(
      message: MmsRetry.MediaRetryNotification,
      options?: $protobuf.IConversionOptions
    ): { [k: string]: any }
