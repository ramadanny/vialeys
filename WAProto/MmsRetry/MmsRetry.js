  ...
  MmsRetry.MediaRetryNotification = (function () {
    ...
    MediaRetryNotification.verify = function verify(message) {
      ...
      if (message.messageSecret != null && message.hasOwnProperty('messageSecret')) {
        ...
        if (
          !(
            (message.messageSecret && typeof message.messageSecret.length === 'number') ||
      ...
      if (object.messageSecret != null)
        if (typeof object.messageSecret === 'string')
          $util.base64.decode(
            ...
            (message.messageSecret = $util.newBuffer($util.base64.length(object.messageSecret))),
            0
          )
        else if (object.messageSecret.length >= 0) message.messageSecret = object.messageSecret
      return message
    }
      ...
      if (message.result != null && message.hasOwnProperty('result')) {
        object.result =
          options.enums === String
            ? $root.MmsRetry.MediaRetryNotification.ResultType[message.result] === undefined
              ? message.result
      ...
      if (message.messageSecret != null && message.hasOwnProperty('messageSecret')) {
        object.messageSecret =
          options.bytes === String
            ? $util.base64.encode(message.messageSecret, 0, message.messageSecret.length)
            : options.bytes === Array
