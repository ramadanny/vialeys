  ...
  CompanionReg.EncryptedPairingRequest = (function () {
    ...
    EncryptedPairingRequest.verify = function verify(message) {
      ...
      if (message.encryptedPayload != null && message.hasOwnProperty('encryptedPayload')) {
        ...
        if (
          !(
            (message.encryptedPayload && typeof message.encryptedPayload.length === 'number') ||
      ...
      if (message.encryptedPayload != null && message.hasOwnProperty('encryptedPayload')) {
        object.encryptedPayload =
          options.bytes === String
            ? $util.base64.encode(message.encryptedPayload, 0, message.encryptedPayload.length)
            : options.bytes === Array
  ...
  CompanionReg.PairingRequest = (function () {
    ...
    PairingRequest.verify = function verify(message) {
      ...
      if (message.companionPublicKey != null && message.hasOwnProperty('companionPublicKey')) {
        ...
        if (
          !(
            (message.companionPublicKey && typeof message.companionPublicKey.length === 'number') ||
    ...
    PairingRequest.fromObject = function fromObject(object) {
      ...
      if (object.advSecret != null)
        if (typeof object.advSecret === 'string')
          $util.base64.decode(
            object.advSecret,
            (message.advSecret = $util.newBuffer($util.base64.length(object.advSecret))),
            0
          )
    ...
    PairingRequest.toObject = function toObject(message, options) {
      ...
      if (message.companionPublicKey != null && message.hasOwnProperty('companionPublicKey')) {
        object.companionPublicKey =
          options.bytes === String
            ? $util.base64.encode(message.companionPublicKey, 0, message.companionPublicKey.length)
            : options.bytes === Array
        ...
        object.companionEphemeralIdentity =
          options.bytes === String
            ...
            : options.bytes === Array
              ...
              : message.companionEphemeralIdentity
        if (options.oneofs) object._companionEphemeralIdentity = 'companionEphemeralIdentity'
      }
      if (message.commitment != null && message.hasOwnProperty('commitment')) {
      ...
      if (message.deviceType != null && message.hasOwnProperty('deviceType')) {
        object.deviceType =
          options.enums === String
            ? $root.CompanionReg.DeviceProps.PlatformType[message.deviceType] === undefined
              ? message.deviceType
  ...
  CompanionReg.DeviceProps = (function () {
    ...
    DeviceProps.decode = function decode(reader, length, error) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 5: {
            message.historySyncConfig = $root.CompanionReg.DeviceProps.HistorySyncConfig.decode(
              reader,
              reader.uint32()
            )
            break
    ...
    DeviceProps.verify = function verify(message) {
      ...
      if (message.requireFullSync != null && message.hasOwnProperty('requireFullSync')) {
        ...
        if (typeof message.requireFullSync !== 'boolean') return 'requireFullSync: boolean expected'
      }
    ...
    DeviceProps.fromObject = function fromObject(object) {
      ...
      if (object.requireFullSync != null) message.requireFullSync = Boolean(object.requireFullSync)
      if (object.historySyncConfig != null) {
        ...
        message.historySyncConfig = $root.CompanionReg.DeviceProps.HistorySyncConfig.fromObject(
    ...
    DeviceProps.toObject = function toObject(message, options) {
      ...
      if (message.platformType != null && message.hasOwnProperty('platformType')) {
        object.platformType =
          options.enums === String
            ? $root.CompanionReg.DeviceProps.PlatformType[message.platformType] === undefined
      ...
      if (message.historySyncConfig != null && message.hasOwnProperty('historySyncConfig')) {
        object.historySyncConfig = $root.CompanionReg.DeviceProps.HistorySyncConfig.toObject(
          message.historySyncConfig,
          options
        )
    ...
    DeviceProps.HistorySyncConfig = (function () {
      ...
      HistorySyncConfig.verify = function verify(message) {
        ...
        if (message.onDemandReady != null && message.hasOwnProperty('onDemandReady')) {
          ...
          if (typeof message.onDemandReady !== 'boolean') return 'onDemandReady: boolean expected'
        }
      ...
      HistorySyncConfig.fromObject = function fromObject(object) {
        if (object instanceof $root.CompanionReg.DeviceProps.HistorySyncConfig) return object
        ...
        if (object.onDemandReady != null) message.onDemandReady = Boolean(object.onDemandReady)
      ...
      HistorySyncConfig.toObject = function toObject(message, options) {
        ...
        if (
          ...
          if (options.oneofs) object._supportCagReactionsAndPolls = 'supportCagReactionsAndPolls'
        }
        if (message.supportBizHostedMsg != null && message.hasOwnProperty('supportBizHostedMsg')) {
        ...
        if (
          ...
          if (options.oneofs) object._supportFbidBotChatHistory = 'supportFbidBotChatHistory'
        }
        if (
          message.supportAddOnHistorySyncMigration != null &&
          message.hasOwnProperty('supportAddOnHistorySyncMigration')
        ...
        if (
          ...
          if (options.oneofs) object._supportMessageAssociation = 'supportMessageAssociation'
        }
        if (message.supportGroupHistory != null && message.hasOwnProperty('supportGroupHistory')) {
