  ...
  ChatLockSettings.ChatLockSettings = (function () {
    ...
    ChatLockSettings.verify = function verify(message) {
      ...
      if (message.hideLockedChats != null && message.hasOwnProperty('hideLockedChats')) {
        ...
        if (typeof message.hideLockedChats !== 'boolean') return 'hideLockedChats: boolean expected'
      }
    ...
    ChatLockSettings.fromObject = function fromObject(object) {
      ...
      if (object.hideLockedChats != null) message.hideLockedChats = Boolean(object.hideLockedChats)
  ...
  UserPassword.UserPassword = (function () {
        ...
        switch (tag >>> 3) {
          ...
          case 3: {
            ...
            message.transformerArg.push(
              $root.UserPassword.UserPassword.TransformerArg.decode(reader, reader.uint32())
            )
            break
          }
          case 4: {
    ...
    UserPassword.verify = function verify(message) {
      ...
      if (message.transformedData != null && message.hasOwnProperty('transformedData')) {
        ...
        if (
          !(
            (message.transformedData && typeof message.transformedData.length === 'number') ||
    ...
    UserPassword.fromObject = function fromObject(object) {
      ...
      if (object.transformerArg) {
        ...
        for (var i = 0; i < object.transformerArg.length; ++i) {
          ...
          message.transformerArg[i] = $root.UserPassword.UserPassword.TransformerArg.fromObject(
    ...
    UserPassword.toObject = function toObject(message, options) {
      ...
      if (message.transformer != null && message.hasOwnProperty('transformer')) {
        object.transformer =
          options.enums === String
            ? $root.UserPassword.UserPassword.Transformer[message.transformer] === undefined
              ? message.transformer
      ...
      if (message.transformerArg && message.transformerArg.length) {
        ...
        for (var j = 0; j < message.transformerArg.length; ++j)
          object.transformerArg[j] = $root.UserPassword.UserPassword.TransformerArg.toObject(
      ...
      if (message.transformedData != null && message.hasOwnProperty('transformedData')) {
        object.transformedData =
          options.bytes === String
            ? $util.base64.encode(message.transformedData, 0, message.transformedData.length)
            : options.bytes === Array
    ...
    UserPassword.TransformerArg = (function () {
      ...
      TransformerArg.decode = function decode(reader, length, error) {
        ...
        while (reader.pos < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 2: {
              message.value = $root.UserPassword.UserPassword.TransformerArg.Value.decode(
                reader,
                reader.uint32()
              )
              break
      ...
      TransformerArg.Value = (function () {
        ...
        Value.fromObject = function fromObject(object) {
          if (object instanceof $root.UserPassword.UserPassword.TransformerArg.Value) return object
          var message = new $root.UserPassword.UserPassword.TransformerArg.Value()
          if (object.asBlob != null)
            if (typeof object.asBlob === 'string')
              $util.base64.decode(
                object.asBlob,
                (message.asBlob = $util.newBuffer($util.base64.length(object.asBlob))),
                0
              )
