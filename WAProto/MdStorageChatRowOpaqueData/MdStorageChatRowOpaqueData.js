  ...
  MdStorageChatRowOpaqueData.ChatRowOpaqueData = (function () {
    ...
    ChatRowOpaqueData.encode = function encode(message, writer) {
      ...
      if (
        ...
        Object.hasOwnProperty.call(message, "draftMessage")
      )
    ...
    ChatRowOpaqueData.encodeDelimited = function encodeDelimited(
      message,
      writer,
    ) {
    ...
    ChatRowOpaqueData.verify = function verify(message) {
      ...
      if (
        message.draftMessage != null &&
        message.hasOwnProperty("draftMessage")
      ) {
    ...
    ChatRowOpaqueData.DraftMessage = (function () {
      ...
      DraftMessage.encode = function encode(message, writer) {
        ...
        if (
          message.omittedUrl != null &&
          Object.hasOwnProperty.call(message, "omittedUrl")
        )
      ...
      DraftMessage.decode = function decode(reader, length, error) {
        ...
        var end = length === undefined ? reader.len : reader.pos + length,
          message =
            new $root.MdStorageChatRowOpaqueData.ChatRowOpaqueData.DraftMessage();
        while (reader.pos < end) {
          var tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      DraftMessage.verify = function verify(message) {
        ...
        if (
          message.omittedUrl != null &&
          message.hasOwnProperty("omittedUrl")
        ) {
        ...
        if (
          message.ctwaContext != null &&
          message.hasOwnProperty("ctwaContext")
        ) {
      ...
      DraftMessage.CtwaContextData = (function () {
        ...
        CtwaContextData.encode = function encode(message, writer) {
          ...
          if (
            ...
            Object.hasOwnProperty.call(message, "mediaUrl")
          )
        ...
        CtwaContextData.encodeDelimited = function encodeDelimited(
          message,
          writer,
        ) {
          return this.encode(message, writer).ldelim();
        ...
        CtwaContextData.verify = function verify(message) {
          ...
          if (
            message.mediaType != null &&
            message.hasOwnProperty("mediaType")
          ) {
      ...
      DraftMessage.CtwaContextLinkData = (function () {
        ...
        CtwaContextLinkData.encodeDelimited = function encodeDelimited(
          message,
          writer,
        ) {
          return this.encode(message, writer).ldelim();
        ...
        CtwaContextLinkData.verify = function verify(message) {
          ...
          if (
            message.icebreaker != null &&
            message.hasOwnProperty("icebreaker")
          ) {
