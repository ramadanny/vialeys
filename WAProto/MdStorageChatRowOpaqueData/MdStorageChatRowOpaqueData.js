  ...
  MdStorageChatRowOpaqueData.ChatRowOpaqueData = (function () {
    ...
    ChatRowOpaqueData.verify = function verify(message) {
      ...
      if (message.draftMessage != null && message.hasOwnProperty('draftMessage')) {
        ...
        {
          var error = $root.MdStorageChatRowOpaqueData.ChatRowOpaqueData.DraftMessage.verify(
            message.draftMessage
          )
      ...
      DraftMessage.CtwaContextData = (function () {
        ...
        CtwaContextData.verify = function verify(message) {
          ...
          if (message.conversionData != null && message.hasOwnProperty('conversionData')) {
            ...
            if (
              !(
                (message.conversionData && typeof message.conversionData.length === 'number') ||
          ...
          if (message.sourceType != null && message.hasOwnProperty('sourceType')) {
            ...
            if (!$util.isString(message.sourceType)) return 'sourceType: string expected'
          }
        ...
        CtwaContextData.fromObject = function fromObject(object) {
          if (
            object instanceof
            $root.MdStorageChatRowOpaqueData.ChatRowOpaqueData.DraftMessage.CtwaContextData
          )
            return object
          var message =
            new $root.MdStorageChatRowOpaqueData.ChatRowOpaqueData.DraftMessage.CtwaContextData()
          ...
          if (message.conversionData != null && message.hasOwnProperty('conversionData')) {
            object.conversionData =
              options.bytes === String
                ? $util.base64.encode(message.conversionData, 0, message.conversionData.length)
                : options.bytes === Array
          ...
          if (message.mediaType != null && message.hasOwnProperty('mediaType')) {
            object.mediaType =
              options.enums === String
                ? $root.MdStorageChatRowOpaqueData.ChatRowOpaqueData.DraftMessage.CtwaContextData
                    .ContextInfoExternalAdReplyInfoMediaType[message.mediaType] === undefined
                  ? message.mediaType
                  : $root.MdStorageChatRowOpaqueData.ChatRowOpaqueData.DraftMessage.CtwaContextData
                      .ContextInfoExternalAdReplyInfoMediaType[message.mediaType]
                : message.mediaType
      ...
      DraftMessage.CtwaContextLinkData = (function () {
        ...
        CtwaContextLinkData.verify = function verify(message) {
          ...
          if (message.icebreaker != null && message.hasOwnProperty('icebreaker')) {
            ...
            if (!$util.isString(message.icebreaker)) return 'icebreaker: string expected'
          }
        ...
        CtwaContextLinkData.fromObject = function fromObject(object) {
          if (
            object instanceof
            $root.MdStorageChatRowOpaqueData.ChatRowOpaqueData.DraftMessage.CtwaContextLinkData
          )
            return object
          var message =
            new $root.MdStorageChatRowOpaqueData.ChatRowOpaqueData.DraftMessage.CtwaContextLinkData()
