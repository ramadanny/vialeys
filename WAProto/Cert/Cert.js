      ...
      NoiseCertificate.Details = (function () {
        ...
        Details.verify = function verify(message) {
          ...
          if (message.issuerSerial != null && message.hasOwnProperty('issuerSerial')) {
            ...
            if (!$util.isInteger(message.issuerSerial)) return 'issuerSerial: integer expected'
          }
        ...
        Details.fromObject = function fromObject(object) {
          if (object instanceof $root.Cert.CertChain.NoiseCertificate.Details) return object
          var message = new $root.Cert.CertChain.NoiseCertificate.Details()
          if (object.serial != null) message.serial = object.serial >>> 0
          if (object.issuerSerial != null) message.issuerSerial = object.issuerSerial >>> 0
          if (object.key != null)
          ...
          if (object.notBefore != null)
            ...
            else if (typeof object.notBefore === 'number') message.notBefore = object.notBefore
          ...
          if (object.notAfter != null)
            ...
            else if (typeof object.notAfter === 'number') message.notAfter = object.notAfter
        ...
        Details.toObject = function toObject(message, options) {
          ...
          if (message.notBefore != null && message.hasOwnProperty('notBefore')) {
            if (typeof message.notBefore === 'number')
              object.notBefore =
                options.longs === String ? String(message.notBefore) : message.notBefore
            else
              object.notBefore =
          ...
          if (message.notAfter != null && message.hasOwnProperty('notAfter')) {
            if (typeof message.notAfter === 'number')
              object.notAfter =
                options.longs === String ? String(message.notAfter) : message.notAfter
            else
              object.notAfter =
                options.longs === String
    ...
    NoiseCertificate.Details = (function () {
      ...
      Details.fromObject = function fromObject(object) {
        ...
        if (object.expires != null)
          if ($util.Long) (message.expires = $util.Long.fromValue(object.expires)).unsigned = true
