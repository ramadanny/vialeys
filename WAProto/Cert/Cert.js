...
$root.Cert = (function () {
  ...
  Cert.CertChain = (function () {
    ...
    CertChain.encode = function encode(message, writer) {
      ...
      if (
        message.intermediate != null &&
        Object.hasOwnProperty.call(message, "intermediate")
      )
        $root.Cert.CertChain.NoiseCertificate.encode(
    ...
    CertChain.verify = function verify(message) {
      ...
      if (message.leaf != null && message.hasOwnProperty("leaf")) {
        properties._leaf = 1;
        {
          var error = $root.Cert.CertChain.NoiseCertificate.verify(
            message.leaf,
          );
      ...
      if (
        message.intermediate != null &&
        message.hasOwnProperty("intermediate")
      ) {
    ...
    CertChain.fromObject = function fromObject(object) {
      ...
      if (object.leaf != null) {
        ...
        message.leaf = $root.Cert.CertChain.NoiseCertificate.fromObject(
          object.leaf,
        );
      }
    ...
    CertChain.toObject = function toObject(message, options) {
      ...
      var object = {};
      if (message.leaf != null && message.hasOwnProperty("leaf")) {
        object.leaf = $root.Cert.CertChain.NoiseCertificate.toObject(
          message.leaf,
          options,
        );
    ...
    CertChain.NoiseCertificate = (function () {
      ...
      NoiseCertificate.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
      ...
      NoiseCertificate.Details = (function () {
        ...
        Details.encode = function encode(message, writer) {
          ...
          if (
            message.notAfter != null &&
            Object.hasOwnProperty.call(message, "notAfter")
          )
        ...
        Details.verify = function verify(message) {
          ...
          if (
            message.issuerSerial != null &&
            message.hasOwnProperty("issuerSerial")
          ) {
          ...
          if (
            message.notBefore != null &&
            message.hasOwnProperty("notBefore")
          ) {
        ...
        Details.fromObject = function fromObject(object) {
          ...
          if (object.notBefore != null)
            if ($util.Long)
              (message.notBefore = $util.Long.fromValue(
                object.notBefore,
              )).unsigned = true;
          ...
          if (object.notAfter != null)
            if ($util.Long)
              (message.notAfter = $util.Long.fromValue(
                object.notAfter,
              )).unsigned = true;
    ...
    NoiseCertificate.Details = (function () {
      ...
      Details.encode = function encode(message, writer) {
        ...
        if (
          ...
          Object.hasOwnProperty.call(message, "expires")
        )
      ...
      Details.fromObject = function fromObject(object) {
        ...
        if (object.expires != null)
          if ($util.Long)
            (message.expires = $util.Long.fromValue(object.expires)).unsigned =
              true;
