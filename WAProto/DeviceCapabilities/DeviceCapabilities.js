  ...
  DeviceCapabilities.DeviceCapabilities = (function () {
    ...
    DeviceCapabilities.decode = function decode(reader, length, error) {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            message.lidMigration = $root.DeviceCapabilities.DeviceCapabilities.LIDMigration.decode(
              reader,
              reader.uint32()
            )
            break
          ...
          case 6: {
            message.aiThread = $root.DeviceCapabilities.DeviceCapabilities.AiThread.decode(
              reader,
              reader.uint32()
            )
            break
    ...
    DeviceCapabilities.verify = function verify(message) {
      ...
      if (message.businessBroadcast != null && message.hasOwnProperty('businessBroadcast')) {
        ...
        {
          var error = $root.DeviceCapabilities.DeviceCapabilities.BusinessBroadcast.verify(
            message.businessBroadcast
          )
    ...
    DeviceCapabilities.fromObject = function fromObject(object) {
      ...
      if (object.lidMigration != null) {
        ...
        message.lidMigration = $root.DeviceCapabilities.DeviceCapabilities.LIDMigration.fromObject(
          object.lidMigration
        )
      }
      ...
      if (object.userHasAvatar != null) {
        ...
        message.userHasAvatar =
          $root.DeviceCapabilities.DeviceCapabilities.UserHasAvatar.fromObject(object.userHasAvatar)
      }
    ...
    DeviceCapabilities.toObject = function toObject(message, options) {
      ...
      if (message.lidMigration != null && message.hasOwnProperty('lidMigration')) {
        object.lidMigration = $root.DeviceCapabilities.DeviceCapabilities.LIDMigration.toObject(
          message.lidMigration,
          options
        )
      ...
      if (message.userHasAvatar != null && message.hasOwnProperty('userHasAvatar')) {
        object.userHasAvatar = $root.DeviceCapabilities.DeviceCapabilities.UserHasAvatar.toObject(
          message.userHasAvatar,
          options
        )
      ...
      if (
        ...
        object.memberNameTagPrimarySupport =
          options.enums === String
            ...
            : message.memberNameTagPrimarySupport
        if (options.oneofs) object._memberNameTagPrimarySupport = 'memberNameTagPrimarySupport'
      }
      if (message.aiThread != null && message.hasOwnProperty('aiThread')) {
    ...
    DeviceCapabilities.AiThread = (function () {
      ...
      AiThread.fromObject = function fromObject(object) {
        if (object instanceof $root.DeviceCapabilities.DeviceCapabilities.AiThread) return object
    ...
    DeviceCapabilities.UserHasAvatar = (function () {
      ...
      UserHasAvatar.verify = function verify(message) {
        ...
        if (message.userHasAvatar != null && message.hasOwnProperty('userHasAvatar')) {
          properties._userHasAvatar = 1
          if (typeof message.userHasAvatar !== 'boolean') return 'userHasAvatar: boolean expected'
        }
        return null
      }
      ...
      UserHasAvatar.fromObject = function fromObject(object) {
        ...
        if (object.userHasAvatar != null) message.userHasAvatar = Boolean(object.userHasAvatar)
        return message
      }
