  ...
  VnameCert.BizIdentityInfo = (function () {
    ...
    BizIdentityInfo.toObject = function toObject(message, options) {
      ...
      if (message.vlevel != null && message.hasOwnProperty('vlevel')) {
        object.vlevel =
          options.enums === String
            ? $root.VnameCert.BizIdentityInfo.VerifiedLevelValue[message.vlevel] === undefined
              ? message.vlevel
      ...
      if (message.hostStorage != null && message.hasOwnProperty('hostStorage')) {
        object.hostStorage =
          options.enums === String
            ? $root.VnameCert.BizIdentityInfo.HostStorageType[message.hostStorage] === undefined
              ? message.hostStorage
      ...
      if (message.actualActors != null && message.hasOwnProperty('actualActors')) {
        object.actualActors =
          options.enums === String
            ? $root.VnameCert.BizIdentityInfo.ActualActorsType[message.actualActors] === undefined
      ...
      if (message.privacyModeTs != null && message.hasOwnProperty('privacyModeTs')) {
        if (typeof message.privacyModeTs === 'number')
          object.privacyModeTs =
            options.longs === String ? String(message.privacyModeTs) : message.privacyModeTs
        else
          object.privacyModeTs =
      ...
      if (message.featureControls != null && message.hasOwnProperty('featureControls')) {
        if (typeof message.featureControls === 'number')
          object.featureControls =
            options.longs === String ? String(message.featureControls) : message.featureControls
        else
          object.featureControls =
            options.longs === String
  ...
  VnameCert.BizAccountLinkInfo = (function () {
    ...
    BizAccountLinkInfo.fromObject = function fromObject(object) {
      ...
      if (object.issueTime != null)
        if ($util.Long) (message.issueTime = $util.Long.fromValue(object.issueTime)).unsigned = true
    ...
    BizAccountLinkInfo.toObject = function toObject(message, options) {
      ...
      if (message.hostStorage != null && message.hasOwnProperty('hostStorage')) {
        object.hostStorage =
          options.enums === String
            ? $root.VnameCert.BizAccountLinkInfo.HostStorageType[message.hostStorage] === undefined
              ? message.hostStorage
              : $root.VnameCert.BizAccountLinkInfo.HostStorageType[message.hostStorage]
            : message.hostStorage
        if (options.oneofs) object._hostStorage = 'hostStorage'
      }
      if (message.accountType != null && message.hasOwnProperty('accountType')) {
        object.accountType =
          options.enums === String
            ? $root.VnameCert.BizAccountLinkInfo.AccountType[message.accountType] === undefined
              ? message.accountType
  ...
  VnameCert.BizAccountPayload = (function () {
    ...
    BizAccountPayload.verify = function verify(message) {
      ...
      if (message.bizAcctLinkInfo != null && message.hasOwnProperty('bizAcctLinkInfo')) {
        ...
        if (
          !(
            (message.bizAcctLinkInfo && typeof message.bizAcctLinkInfo.length === 'number') ||
      ...
      if (message.bizAcctLinkInfo != null && message.hasOwnProperty('bizAcctLinkInfo')) {
        object.bizAcctLinkInfo =
          options.bytes === String
            ? $util.base64.encode(message.bizAcctLinkInfo, 0, message.bizAcctLinkInfo.length)
            : options.bytes === Array
  ...
  VnameCert.VerifiedNameCertificate = (function () {
    ...
    VerifiedNameCertificate.verify = function verify(message) {
      ...
      if (message.serverSignature != null && message.hasOwnProperty('serverSignature')) {
        ...
        if (
          !(
            (message.serverSignature && typeof message.serverSignature.length === 'number') ||
    ...
    VerifiedNameCertificate.toObject = function toObject(message, options) {
      ...
      if (message.serverSignature != null && message.hasOwnProperty('serverSignature')) {
        object.serverSignature =
          options.bytes === String
            ? $util.base64.encode(message.serverSignature, 0, message.serverSignature.length)
            : options.bytes === Array
    ...
    VerifiedNameCertificate.Details = (function () {
      ...
      Details.fromObject = function fromObject(object) {
        if (object instanceof $root.VnameCert.VerifiedNameCertificate.Details) return object
        var message = new $root.VnameCert.VerifiedNameCertificate.Details()
        if (object.serial != null)
          if ($util.Long) (message.serial = $util.Long.fromValue(object.serial)).unsigned = true
          else if (typeof object.serial === 'string') message.serial = parseInt(object.serial, 10)
